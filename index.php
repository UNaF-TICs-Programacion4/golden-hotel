            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#reserva">Reservas</a></li>                        
                        <li class="scroll"><a href="#reporte">Reporte</a></li>   
                    </ul>
                </div>
            </div><!--/.container-->
        </nav><!--/nav-->
...
<p class="wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa <br> semper aliquam quis mattis quam.</p> 
  ...
  <section id="reserva">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title wow fadeInDown">Reservas</h2>
                <p class="wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa <br> semper aliquam quis mattis quam.</p>
            </div>
        </div>
                        ...
                        <div class="contact-form">
                            <form id="main-contact-form" name="contact-form" method="post" action="index.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                    <div class="col-xs-4">
                                      <select class="form-control col-sm-2" name="dia-entrada" id="expiry-month">
                                        <option>Día</option>
                                    ...
                                    <div class="col-xs-4">
                                      <select class="form-control col-sm-2" id="expiry-month" name="mes-entrada">
                                        <option>Mes</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                    <div class="col-xs-4">
                                      <select class="form-control col-sm-2" id="expiry-month" name="dia-salida">
                                        <option >Día</option>
                                        <option value="01">1</option>
                                        <option value="02">2</option>
                                        <option value="03">3</option>
                                    ...
                                    <div class="col-xs-4">
                                      <select class="form-control col-sm-2" id="expiry-month" name="mes-salida">
                                        <option >Mes</option>
                                        <option value="01">Enero</option>
                                        <option value="02">Febrero</option>
                                        <option value="03">Marzo</option>
 ...
 <section id="reporte">
        <div class="container">
            <div class="section-header">
                <h2 class="section-title wow fadeInDown">Reporte</h2>
                <p class="wow fadeInDown">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent eget risus vitae massa <br> semper aliquam quis mattis quam.</p>
            </div>
        </div>
